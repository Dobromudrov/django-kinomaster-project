# Generated by Django 4.0.4 on 2022-05-04 12:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(related_name='film_actor', to='movies.actors', verbose_name='Актёры')),
                ...
                ('directors', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='movies.directors', verbose_name='Режиссёр')),
